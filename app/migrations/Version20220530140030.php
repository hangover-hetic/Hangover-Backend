 ...
 */
final class Version20220530140030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bought_package ADD package_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_F0F0C7ABF44CABFF');
        $this->addSql('ALTER TABLE bought_package DROP package_id');
    }
}
